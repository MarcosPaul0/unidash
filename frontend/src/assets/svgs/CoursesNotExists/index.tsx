import { CoursesNotExistsProps } from "./coursesNotExists.interface";

export function CoursesNotExists({ className }: CoursesNotExistsProps) {
  return (
    <svg
      className={className}
    ...
    >
      ...
      <g id="freepik--speech-bubble--inject-75">
        <g id="freepik--speech-bubble--inject-75">
          ...
          <g id="freepik--dead-emoji--inject-75">
            <path
